      ...
      try {
        if (navigator.onLine) {
          ...
          try {
            ...
            setMedicalFormData({
              firstName: data.data && data.data.firstName ? data.data.firstName : data.firstName,
              lastName: data.data && data.data.lastName ? data.data.lastName : data.lastName,
              email: data.data && data.data.email ? data.data.email : data.email,
              gender: data.data && data.data.gender ? data.data.gender : data.gender,
              dob: data.data && data.data.dob ? data.data.dob : data.dob,
              phoneNumber: data.data && data.data.phoneNumber ? data.data.phoneNumber : data.phoneNumber,
              height: data.data && data.data.height ? data.data.height : data.height,
              weight: data.data && data.data.weight ? data.data.weight : data.weight,
              bmi: data.data && data.data.bmi ? data.data.bmi : data.bmi,
              disease: data.data && data.data.disease ? data.data.disease : data.disease,
